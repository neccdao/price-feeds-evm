 ...
 */
contract SimpleWriteAccessController is AccessControllerInterface, AccessControl {
    ...
    constructor(address _validator) {
        _setupRole(ACCESS_CONTROLLER_ROLE, _validator);
        checkEnabled = true;
    }
    ...
    function addAccess(address _user) external {
        require(hasRole(ACCESS_CONTROLLER_ROLE, msg.sender), "Caller is not a validator");
